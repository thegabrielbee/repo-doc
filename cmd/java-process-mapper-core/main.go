...
func usage() {
	fmt.Fprintf(os.Stderr, `java-process-mapper-core %s

Usage:
  java-process-mapper-core serve
  java-process-mapper-core scan --root <path> --out <path> --addons spring
  java-process-mapper-core scan --root <path> --addons javaee --java-version 8
